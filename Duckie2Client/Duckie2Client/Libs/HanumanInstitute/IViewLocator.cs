...
/// <summary>Interface responsible for finding a dialog type matching a view model.</summary>
public interface IViewLocator
{
    /// <summary>Get the view type based on the specified view model.</summary>
    ...
    /// <summary>Creates a view based on the specified view model.</summary>
